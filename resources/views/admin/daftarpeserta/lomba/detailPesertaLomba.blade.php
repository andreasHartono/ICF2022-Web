...
@section('header')
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Detail Peserta</li>
    </ol>
    <h6 class="font-weight-bolder text-white mb-0">Detail Peserta Tim {{ $nama }}</h6>
@endsection
@section('content')
<div class="row">
    <div class="col-12">
