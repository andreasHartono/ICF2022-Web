...
@section('header')
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Tim Lomba Mobile Legends</li>
    </ol>
    <h6 class="font-weight-bolder text-white mb-0">Mobile Legends Competition</h6>
@endsection
@section('content')
<div class="row">
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          <h6>List Tim Mobile Legends Competition</h6>
