                            ...
                            <div class="timeline-info">
                                ...
                                <div class="content content1">
                                    ...
                                    {{-- <div class="row">
                                        ...
                                        <div class="col">
                                            <p>Satu tim terdiri dari 3 siswa Sekolah Menengah Atas (SMA)/sederajat yang
                                                berasal dari sekolah yang sama <b>(boleh berasal dari jenjang dan peminatan
                                                    yang berbeda)</b>.</p>
                                        </div>
                                    </div> --}}
                                </div>
        ...
        {{-- <div class="accordion" id="accordionPanelsStayOpenExample">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        <p>
                            ...
                            multimedia untuk anak SMA/K sederajat yang mencakup <i>rally games, game concept design</i>, dan
            ...
            <div class="accordion-item faq-radialGradient">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed color-title-faq faq-radialGradient-title" type="button"
                        ...
                        <p style="margin-bottom: 0;">Apakah MANIAC XI akan diadakan secara&nbsp <i>offline</i> atau
                            <i>online</i>?</p>
                    </button>
                </h2>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Tidak, MANIAC XI berfokus pada bidang multimedia. Bidang akademis hanya akan diuji di beberapa pos
                        pada rally games.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        MANIAC hanya berfokus pada 2 bidang Multimedia, yaitu <i>game concept design</i> dan <i>asset
                            design</i>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Pendaftaran dilakukan secara online dengan mengisi form pendaftaran yang tersedia di website <a
                            href="https://maniac.ifubaya.id">maniac.ifubaya.id</a>
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapse19" class="accordion-collapse collapse" aria-labelledby="heading19"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Untuk kelas 12 angkatan lulus Tahun Ajaran 2021/2022 tidak diperbolehkan, sedangkan untuk angkatan
                        yang naik ke kelas 12 pada Tahun Ajaran 2022/2023 diperbolehkan, asalkan mendapat izin dari sekolah
                        dan memiliki bukti status kesiswaan.
                    </div>
                </div>
            </div>
            <br>
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapse20" class="accordion-collapse collapse" aria-labelledby="heading20"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Diperbolehkan, dengan syarat tetap berada di jenjang yang sama (SMA/K sederajat), dan untuk kelas 12
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapse22" class="accordion-collapse collapse" aria-labelledby="heading22"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Diperbolehkan, namun ada batasan waktu, yaitu 2 minggu sebelum diadakannya <i>Technical Meeting</i>
                        Babak Penyisihan
                    </div>
                </div>
            </div>
