                    ...
                    <form method="POST" action="{{ url('/registermlbb') }}" class="mt-5" enctype="multipart/form-data">
                        ...
                        <div class="data-anggota anggota-2">
                            ...
                            <input type="text" name="no_hp2" id="txtNoHpAnggota2"
                                class="myTextbox width-90 @error('no_hp2') is-invalid @enderror" placeholder="Nomor HP">
                            @error('no_hp2')
                                <div class="invalid-feedback text-center">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="data-anggota anggota-2">
                            ...
                            <input type="text" name="no_hp3" id="txtNoHpAnggota3"
                                class="myTextbox width-90 @error('no_hp3') is-invalid @enderror" placeholder="Nomor HP">
                            @error('no_hp3')
                                <div class="invalid-feedback text-center">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="data-anggota anggota-2">
                            ...
                            <input type="text" name="no_hp4" id="txtNoHpAnggota4"
                                class="myTextbox width-90 @error('no_hp4') is-invalid @enderror" placeholder="Nomor HP">
                            @error('no_hp4')
                                <div class="invalid-feedback text-center">
                                    {{ $message }}
                                </div>
